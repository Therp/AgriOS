...
class BulkContractAbstractWizard(models.AbstractModel):
    ...
    loc_area_6_ids = fields.Many2many('area.level.6', domain="[('country_id','=', country_id)]", string='Area Level 6')
    loc_area_5_ids = fields.Many2many('area.level.5', domain="[('country_id','=', country_id)]", string='Area Level 5')
    loc_area_4_ids = fields.Many2many('area.level.4', domain="[('country_id','=', country_id)]", string='Area Level 4')
    loc_area_3_ids = fields.Many2many('area.level.3', domain="[('country_id','=', country_id)]", string='Area Level 3')
    loc_area_2_ids = fields.Many2many('area.level.2', domain="[('country_id','=', country_id)]", string='Area Level 2')
    loc_area_1_ids = fields.Many2many('area.level.1', domain="[('country_id','=', country_id)]", string='Area Level 1')
