...
class ConfirmContractsWizard(models.TransientModel):
    ...
    contract_ids = fields.Many2many(
        "farmer.contract",
        string="Draft Contracts To Confirm",
    ...
    def confirm_contracts(self):
        draft_contracts = self.contract_ids.filtered(
            lambda cont: cont.contract_stage == "draft"
        )
        ...
        return {
            ...
            "params": {
                "message": _("All %d contracts have been confirmed.")
                % len(draft_contracts),
                "type": "success",
                "sticky": False,
