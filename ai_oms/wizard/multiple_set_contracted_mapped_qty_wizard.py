...
class SetMappedQuantitiesWizard(models.TransientModel):
    ...
    contract_ids = fields.Many2many('offtake.agreement', string='Draft Contracts To Update', domain=[('contract_stage','=','draft')])
    ...
    def update_contracts(self):
        ...
        return {
                ...
                'params': {
                    'message': _("All %d contracts have been updated.") % len(self.contract_ids),
                    'type': 'success',
                    'sticky': False,
