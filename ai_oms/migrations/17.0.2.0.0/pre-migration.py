...
def migrate(cr, version):
    ...
    cr.execute("DELETE FROM ir_ui_view WHERE name = 'view.oms.res.config.settings.form';") # Delete OMS configurations view to be recreated again to avoid conflicts
