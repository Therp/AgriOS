...
export class MapWidget extends Component {
    ...
    static props = {
        ...
        area_measurement: {
            type: String,
            optional: true,
            validate: (props) => ["square_meters", "acres"].includes(props),
        },
    };
    static defaultProps = {
    ...
    getCountryGeo(country_code) {
        const countries = [
            ...
            {
                code: "AS",
                geo: { latitude: -14.270972, longitude: -170.132217 },
            },
        ...
        const searchText = country_code
            ? country_code.toUpperCase().trim()
            : null;
        const results = [];
